...
l3pp_t l3_prepare(l3info_t l3info, mm_t mm) {
  ...
  bzero(l3, sizeof(struct l3pp)); //ensures the memory is initialized to zero
  if (l3info != NULL)
...
void **l3_get_monitoredhead(l3pp_t l3) {
    return l3->monitoredhead;
}

int l3_get_nmonitored(l3pp_t l3) {
